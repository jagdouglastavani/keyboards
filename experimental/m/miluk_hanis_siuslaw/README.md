...
Description
-----------
This keyboard was made by Jordan AG Douglas-Tavani for typing hanis tɬ'ii'iis (Hanis), miluk tɬiis (Miluk), and shaʼyuushtɬʼa quuiich (Siuslaw) in accordance with the Confederated Tribes of Coos, Lower Umpqua, and Siuslaw Indians classroom orthography. The computer-based keyboard does not represent every sound in the languages, but rather, the characters used to create those sounds. This means that the 'ch' sound is created by combining both the characters of 'c' and 'h'. Meanwhile, the mobile keyboards have longpress utilization. This allows for all sounds in the language to be represented, such as 'ch', 'sh', 'hw', etc.; with their own keys. 
